...
<div class="container">
  <div class="section" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('./workoutLogger.jpg')">
    <h2>Workout Logger</h2>
    <p>Log your sets, reps, and workout duration.</p>
    <a href="./workoutlog.php">Open</a>
  </div>

  <div class="section" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('./progress.jpg')">
    <h2>Exercise Library</h2>
    <p>Browse exercises with animations and filters.</p>
    <a href="./exercise.php">Open</a>
  </div>

  <div class="section" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('./chart.jpg')">
    <h2>Progress Charts</h2>
    <p>See visual graphs of your fitness journey.</p>
    <a href="./progess.php">Open</a>
  </div>

  <div class="section" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('./water.jpg')">
    <h2>Water Tracker</h2>
